...
<div class="row">
    ...
    ?>
                ...
                <script type="text/javascript">
                    setTimeout(function(){
                        window.location.href='/area-administrativa';
                    }, 3000);
...
<div class="col-sm-4 col-md-4 col-md-offset-4 col-sm-offset-4">
    ...
    <div class="account-wall">
        <center><img class="img-circle" src="web-files/images/icon/user.png" alt="user logo" style="width:200px;height: 150px;"></center><br><br>
